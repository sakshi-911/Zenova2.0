export default function Footer() {
    return (
      <footer className="bg-cosmic-800 text-purple-300 py-6 mt-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            {/* Left Section */}
            <div className="text-center md:text-left">
              <h3 className="text-lg font-bold text-purple-400">Solar System Explorer</h3>
              <p className="text-sm">Explore the wonders of our cosmic neighborhood</p>
            </div>
            ...
            <div className="text-center md:text-right">
              <p className="text-sm">
                &copy; {new Date().getFullYear()} Solar System Explorer. All rights reserved.
              </p>
